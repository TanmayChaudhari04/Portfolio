        ...
        <div id="About">
            <div>
                ...
                <input
                    id="chat"
                    rows="1"
                    className="ml-80 p-2.5 w-6/12 text-sm text-gray-900 bg-gray-700 rounded-lg border border-gray-600 focus:ring-0 focus:border-gray-600 dark:bg-gray-800 dark:border-gray-800 dark:placeholder-gray-500 dark:text-white dark:focus:ring-0 dark:focus:border-gray-600"
                ...
                <button
                    type="button"
                    className="mt-6 ml-6 text-white bg-sky-700 hover:bg-sky-100 focus:ring-4 focus:outline-none focus:ring-sky-200 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center me-2 dark:bg-sky-800 dark:hover:bg-sky-700 dark:focus:ring-sky-800"
                ...
                <div className="text-center text-white mt-9 text-xl mx-28" dangerouslySetInnerHTML={{ __html: replyText }} />
